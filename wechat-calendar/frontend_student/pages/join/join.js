...
Page({
  ...
  onLoad(options) {
    ...
    const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJjYWxfaWQiOjUsImV4cCI6MTc3NjQxMDc4NiwidHlwZSI6Imludml0ZSJ9.E10ciSDCZgIjeqPM7uJuHJsllgda4ZxtORZTxLDXrWg"
    if (!token) {
